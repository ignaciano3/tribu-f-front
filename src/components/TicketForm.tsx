export default function TicketForm() {
    return (
        ...
        <div>
          ...
          <textarea id="description" name="description" rows={4} placeholder="Describe el problema" />
        </div>
        <div>
        ...
        <div className="input-group">
          ...
          <select id="tareasAsociadas" name="tareasAsociadas[]" multiple>
            </select>
          <button type="button" className="create-task-button">Crear tarea</button>
        </div>
        <div>
